...
<script type="text/javascript" src="{{asset('vendor/harimayco/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/harimayco/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/harimayco/menu.js')}}"></script>