<table class="table table-striped table-bordered table-hover dataTables-example">
	<thead>
		<tr>
			...
			<th class="text-center">Tên bộ sưu tập</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{ $obj->number_image }}</td>
			...
			<td class="text-center">
				<a href="{{route('album.edit', ['id'=>$obj->id])}}" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
				<a 	class="btn btn-danger btn-circle btn-sm delete-button"
					data-action ="{{ route('album.destroy',$obj->id) }}" type="button">
