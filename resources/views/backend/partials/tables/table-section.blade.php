<table class="table table-striped table-bordered table-hover dataTables-example">
	<thead>
		<tr>
			...
			<th class="text-center">Trang hiển thị</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{$obj->Page != null ? $obj->Page->name : ''}}</td>
			...
			<td class="text-center">
				<a href="{{route('section.edit', ['id'=>$obj->id])}}" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
				<a 	class="btn btn-danger btn-circle btn-sm delete-button"
					data-action ="{{ route('section.destroy',$obj->id) }}" type="button">
