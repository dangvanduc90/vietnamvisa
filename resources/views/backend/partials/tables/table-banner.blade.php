<table class="table table-striped table-bordered table-hover dataTables-example">
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{$obj->page != null ? $obj->page->name : ''}}
			</td>
			...
			<td class="text-center">
				<a href="{{route('banner.edit', ['id'=>$obj->id])}}" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
				<a 	class="btn btn-danger btn-circle btn-sm delete-button"
					data-action ="{{ route('banner.destroy',$obj->id) }}" type="button">
