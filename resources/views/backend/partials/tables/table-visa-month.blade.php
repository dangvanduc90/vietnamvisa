<table class="table table-striped table-bordered table-hover dataTables-example">
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{$obj->month_text}}</td>
            <td class="text-center">{{$obj->purpose->type}}</td>
			<td class="text-center">
				<a href="{{route('month.edit', ['id'=>$obj->id])}}" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a>
				<a 	class="btn btn-danger btn-circle btn-sm delete-button"
					data-action ="{{ route('month.destroy',$obj->id) }}" type="button">
